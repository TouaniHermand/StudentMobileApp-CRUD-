...
export default function AjouterEtudiant() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const nouvelEtudiant: Omit<Etudiant, "id"> = {
        ...formData,
      ...
      Alert.alert("Erreur", "Impossible d'ajouter l'étudiant");
    }
  };
    ...
    >
      <ScrollView style={styles.scrollView}>
        <View style={styles.form}>
          <Text style={styles.title}>Ajouter un Nouvel Étudiant</Text>
      ...
      <LoadingOverlay
        visible={loading}
        message="Ajout de l'étudiant en cours..."
      />
    </KeyboardAvoidingView>
  );
}
